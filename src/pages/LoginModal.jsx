...
const LoginModal = () => {
  ...
  return (
    <div className="bg-[#0000007d] w-full min-h-screen fixed inset-0 z-30 flex items-center justify-center font-karla">
      ...
      >
        <RxCross1 onClick={handleClickClose} className="absolute cursor-pointer right-5 top-5 hover:opacity-85" />
        ...
        {isRegister ? (
          <>
            ...
            <p className="leading-4">
              This is a hobby project for development purposes only. No well-suited
